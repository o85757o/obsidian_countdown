import { App, Plugin, PluginSettingTab, Setting, editorViewField } from 'obsidian';
...
export default class CountdownPlugin extends Plugin {
    ...
    async onload() {
        ...
        this.registerMarkdownPostProcessor((element, context) => {
            this.processCountdownSyntax(element);
        });
    ...
    private processCountdownSyntax(element: HTMLElement) {
            ...
            matches.forEach(match => {
                ...
                if (!isNaN(date.getTime())) {
                    ...
                    new ClockFace(container, {
                        endDate: date,
                        style: style,
                        title: options.title,  // 将title传递给ClockFace组件
